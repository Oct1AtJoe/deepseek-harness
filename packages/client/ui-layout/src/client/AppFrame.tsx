...
import { computeColumns, rightbarDefault, SIDEBAR_AUTO_COLLAPSE, SIDEBAR_DEFAULT } from './columns.ts'
...
export function AppFrame({
  ...
  const rightbarPreference = layoutInfo.rightbar ?? rightbarDefault(viewport)
